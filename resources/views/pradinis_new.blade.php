        ...
        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="tm-flex-center p-5">
                <div class="tm-md-flex-center">
                    ...
                    <a href="/quiz/klausimas" class="btn btn-primary float-lg-right tm-md-align-center">Bandyti testą</a>
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 p-0">
        ...
        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="tm-flex-center p-5">
                <div class="tm-md-flex-center">
                    ...
                    <a href="/quiz/klausimas" class="btn btn-primary float-lg-right tm-md-align-center">Mokymo įstaigos</a>
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 p-0">
        ...
        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="tm-flex-center p-5">
                <div class="tm-flex-center tm-flex-col">
                    ...
                    <a href="kaip_istoti" class="btn btn-primary">Klausti</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="tm-flex-center p-5">
                <div class="tm-md-flex-center">
                    ...
                    <a href="/quiz/klausimas" class="btn btn-primary float-lg-right tm-md-align-center">Statistika</a>
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 p-0">
